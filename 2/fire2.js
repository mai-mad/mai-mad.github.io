var Fireworks2 = function(){
    ...
    self.init = function(){
        ...
        self.canvasContainer = $('#canvas-container2');

        var canvasContainerDisabled = document.getElementById('canvas-container2');
...
function win0() {
    var fworks = new Fireworks2();
    var gui = new dat.GUI({
        autoPlace: false,
        load: guiPresets,
        preset: 'Default'
    });
    var customContainer = document.getElementById('gui2');
    customContainer.appendChild(gui.domElement);

    var guiFireworks = gui.addFolder('Fireworks2');
